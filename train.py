...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x, ve, cos_sin, window_size):
        ...
        if window_size[0] < 0 or window_size[0] >= T:
...
print("fetching batch"); x, y, epoch = next(train_loader); print("forward pass")  # prefetch first batch
...
while True:
    ...
    for micro_step in range(grad_accum_steps):
        ...
        loss.backward()
        print("fetching batch"); x, y, epoch = next(train_loader); print("forward pass")
